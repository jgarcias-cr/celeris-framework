...
/**
 * Purpose: implement in memory opaque token store behavior for the Security subsystem.
 * How: encapsulates its responsibilities behind explicit methods and typed dependencies.
 * Used in framework: invoked by security components when in memory opaque token store functionality is required.
 */
final class InMemoryOpaqueTokenStore implements OpaqueTokenStoreInterface
{
