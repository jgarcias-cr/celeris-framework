...
/**
 * Purpose: bridge framework contracts with an external/runtime road runner adapter integration.
 ...
 */
final class RoadRunnerAdapter implements WorkerAdapterInterface
{
   ...
   private static function normalizeFrame(RuntimeRequest|array $frame): RuntimeRequest
   {
      ...
      if (!$context instanceof RequestContext || !$request instanceof Request) {
         throw new InvalidArgumentException(
            'RoadRunner receiver must return RuntimeRequest or array with RequestContext + Request.'
         );
      }
